...
# This is to document how to inject data into the databases from api. It's not part of the pipline
...
while True:
    url = 'https://api.coingecko.com/api/v3/coins/bitcoin?localization=false&tickers=true&market_data=true&community_data=false&developer_data=false&sparkline=false'
